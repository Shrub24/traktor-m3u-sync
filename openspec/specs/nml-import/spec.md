...
Import UTF-8 `.m3u8` playlists into a managed sandbox inside Traktor `collection.nml`, preserving supported playlist hierarchy, membership, and ordering while protecting the underlying collection file.
